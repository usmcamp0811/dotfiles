{ stdenv, lib, requireFile, unzip, glib, systemd, nss, nspr, gtk3-x11, pango
, atk, cairo, gdk-pixbuf, xorg, xorg_sys_opengl, util-linux, alsa-lib, dbus
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = requireFile {
    ...
    url =
      "https://downloads.exodus.com/releases/exodus-linux-x64-${finalAttrs.version}.zip";
