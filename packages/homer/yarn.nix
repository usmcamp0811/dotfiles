{
  ...
  packages = [
    ...
    }
    {
      ...
      path = fetchurl {
        name = "caniuse_lite___caniuse_lite_1.0.30001362.tgz";
        url = "https://registry.yarnpkg.com/caniuse-lite/-/caniuse-lite-1.0.30001362.tgz";
    ...
    }
    {
      ...
      path = fetchurl {
        ...
        sha512 = "ADtMkfHuWq4tskJsri2n2FZkORO8ZyhI+zIz7zTrDAgDEtct1jdxOg3YsZBfHhKjmMoWLOSCr+64qrEDGo/DbQ==";
      };
    }
    {
