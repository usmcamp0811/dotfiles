...
*If you are running Windows I HIGHLY!! HIGHLY!! Recommend you at least install and setup [Windows Sub-system for Linux (WSL)](https://docs.microsoft.com/en-us/windows/wsl/install-win10)... or just switch to Linux :-)*
...
*NOTE: This is still a work in progress but it does work as it was adapted from an [issue](https://github.com/python-poetry/poetry/issues/366) on the Poetry GitHub*
```yaml
variables:
...
*NOTE: This is also still under development but the basics are here*
```yaml
