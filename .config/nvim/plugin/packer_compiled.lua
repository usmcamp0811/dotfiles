...
_G.packer_plugins = {
  ...
  ["nim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/mcamp/.local/share/nvim/site/pack/packer/start/nim-ts-context-commentstring",
    url = "https://github.com/JoosepAlviste/nim-ts-context-commentstring"
  },
  ["nlsp-settings.nvim"] = {
    loaded = true,
