...
augroup code_block_color
    ...
    " au BufWritePost *.jl hi markdownCodeBlockBG ctermbg=black guibg=#21242b
    " au BufEnter *.jl hi markdownCodeBlockBG ctermbg=black guibg=#21242b
    " au BufWritePost *.jl hi String ctermbg=black guibg=#21242b
