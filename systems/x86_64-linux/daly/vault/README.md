...
Next to make this vault plicy-agent work you need to go create an approle for the vault policy agent thing. Then go give that approle the admin.hcl policy. 
