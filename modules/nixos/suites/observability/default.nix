      ...
      services = {
        ...
        prometheus = {
          ...
          additionalScrapeConfigs = [{
            ...
            static_configs = [{
              targets = [
                "${config.networking.hostName}:9012"
              ]; # Assuming the node exporter runs on port 9012
            }];
          ...
          additionalScrapeConfigs = [{
            ...
            relabel_configs = [
              # Match specific borgbackup services and count their successful deactivations
              {
                ...
                regex =
                  "borgbackup-job-webb_rsync.service|borgbackup-job-daly_rsync.service|borgbackup-job-campground.service";
                action = "keep";
              }
              {
