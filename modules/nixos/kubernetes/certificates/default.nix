...
with lib; {
  options.campground.kubernetes.certificates.enable = mkEnableOption "Deploy cert-manager and wildcard certificates";

  config = mkIf config.campground.kubernetes.certificates.enable {
