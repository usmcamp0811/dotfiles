    ...
    campground.home.extraOptions = {
      ...
      in nested-default-attrs {
        ...
        "org/gnome/desktop/interface" = {
          color-scheme =
            if cfg.color-scheme == "light" then "default" else "prefer-dark";
        ...
        "org/gnome/shell/extensions/Logo-menu" = {
          ...
          menu-button-terminal =
            if config.campground.desktop.addons.term.enable then
              lib.getExe config.campground.desktop.addons.term.pkg
            else
