...
with lib.fmf; let
  ...
  # Fetched from GitLab Pages with hash verification.
  # The create-pages CI job fetches the upstream file, computes the hash,
  # updates this file, and publishes to Pages.
  # See .gitlab-ci.yml for the CI job.
