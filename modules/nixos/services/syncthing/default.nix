...
in
{
  ...
  # TODO: use variablese from config as defaults
    dataDir = mkOpt str "/home/mcamp/Documents" "Default folder for new synced folders";
    configDir = mkOpt str "/home/mcamp/.config/syncthing" "# Folder for Syncthing's settings and keys";
  };
